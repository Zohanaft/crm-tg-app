...
onMounted(() => {
  ...
  window.__telegramAuthHandler = (user) => onTelegramAuth(user as ITelegramAuthUser)
  ...
  if (props.mode === 'redirect') {
    script.setAttribute('data-auth-url', props.redirectUrl || `${window.location.origin}/auth/telegram`)
  } else {
...
onUnmounted(() => {
  if (import.meta.client) {
    window.__telegramAuthHandler = undefined
  }
})
</script>
